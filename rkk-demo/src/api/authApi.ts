...
export const authApi = {
  ...
  googleLogin: (data: GoogleLoginReq) =>
    apiClient.post<LoginRes>("/auth/google", data).then((r) => r.data),

  register: (data: RegisterReq) =>
    apiClient
      .post<RegisterRes>("/auth/email/register", data)
      .then((r) => r.data),
  ...
  verifyEmail: (token: string) =>
    apiClient
      .get<SuccessRes>("/auth/verify/email", { params: { token } })
      .then((r) => r.data),

  resendVerifyEmail: (data: ResendVerifyEmailReq) =>
    apiClient
      .post<SuccessRes>("/auth/verify/email/resend", data)
      .then((r) => r.data),

  forgotPassword: (data: ForgotPasswordReq) =>
    apiClient
      .post<SuccessRes>("/auth/forgot-password", data)
      .then((r) => r.data),

  verifyResetToken: (data: VerifyForgotPasswordReq) =>
    apiClient
      .post<VerifyResetRes>("/auth/verify/forgot-password", data)
      .then((r) => r.data),

  resetPassword: (data: ResetPasswordReq) =>
    apiClient
      .post<SuccessRes>("/auth/reset-password", data)
      .then((r) => r.data),

  changePassword: (data: ChangePasswordReq) =>
    apiClient
      .post<SuccessRes>("/users/me/change-password", data)
      .then((r) => r.data),
};
